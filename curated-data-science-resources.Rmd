...
## Template: The sf R package for creating maps with ggplot2

Link to resource: https://r-spatial.github.io/sf/
Josh Rosenberg
...
- people who are interested in mapping

### Advice on how to use

- to get started, I recommend creating a map with a few data points to understand where they are.
