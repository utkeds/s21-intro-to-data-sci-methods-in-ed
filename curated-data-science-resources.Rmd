...
## Stackoverflow.com:  Community issue troubleshooting
Link to resource: https://stackoverflow.com/
Ashley West

### What this resource is

- This is a community based site that allows users to both pose questions and troubleshoot others issues with coding, rstudio, etc.  It reminds me a lot of yahoo answers.

### Who will find this resource helpful

- This website will be helpful to people who are having very specific issues that they can't figure out on their own.  This site is also great because you can see all answers provided, so if one solution doesn't work you can try the next one.

### Advice on how to use

- This would be most helpful if you created an account to ask more specific questions, however my questions were easy to find since they were already asked.  They also have a helpful search bar that can be used so you are not asking the same questions over and over.  I was able to find solutions to issues I didn't know how to descride just by using specifc keywords.
