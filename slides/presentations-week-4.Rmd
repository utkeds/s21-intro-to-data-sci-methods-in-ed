...
- What's something strange you're inordinately interested in?
- What's something about using R that has "clicked" for you in the last week?
- What's something about using R that you're still waiting to have click?
...
Different ways of doing the data filter step, right and wrong:


```{r, eval = FALSE}
data %>% filter(content == 1, content == 2, content == 3, content == 4, content == 5)
```
