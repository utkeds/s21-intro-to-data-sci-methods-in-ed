...
knitr::include_graphics(here("slides", "img", "excel.png"))
```
...
knitr::include_graphics(here("slides", "img", "r.png"))
```

---

```{r echo=FALSE, out.width="73%", fig.align="left"}
knitr::include_graphics(here("slides", "img", "rstudio.png"))
```

---

```{r echo=FALSE, out.width="90%", fig.align="left"}
knitr::include_graphics(here("slides", "img", "data-science-cycle", "data-science-cycle.001.png"))
```

---

```{r echo=FALSE, out.width="90%", fig.align="left"}
knitr::include_graphics(here("slides", "img", "data-science-cycle", "data-science-cycle.002.png"))
```

---

```{r echo=FALSE, out.width="90%", fig.align="left"}
knitr::include_graphics(here("slides", "img", "data-science-cycle", "data-science-cycle.003.png"))
```

---

```{r echo=FALSE, out.width="90%", fig.align="left"}
knitr::include_graphics(here("slides", "img", "data-science-cycle", "data-science-cycle.004.png"))
```

---

```{r echo=FALSE, out.width="90%", fig.align="left"}
knitr::include_graphics(here("slides", "img", "data-science-cycle", "data-science-cycle.005.png"))
```

---

```{r echo=FALSE, out.width="90%", fig.align="left"}
knitr::include_graphics(here("slides", "img", "data-science-cycle", "data-science-cycle.006.png"))
```
...
```{r echo=FALSE, out.width="90%", fig.align="left"}
knitr::include_graphics(here("slides", "img", "data-science-cycle", "data-science-cycle.007.png"))
```

---

```{r echo=FALSE, out.width="90%", fig.align="left"}
knitr::include_graphics(here("slides", "img", "data-science-cycle", "data-science-cycle.008.png"))
```

---

```{r echo=FALSE, out.width="90%", fig.align="left"}
knitr::include_graphics(here("slides", "img", "data-science-cycle", "data-science-cycle.009.png"))
```
