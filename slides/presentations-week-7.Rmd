---
title: "Week 7 - Further into Data Viz (p. 2)" 
subtitle: ""
...
```{r, eval = TRUE, echo = FALSE, message = FALSE, out.width="500px"}
tidykids %>% 
  filter(variable == "PK12ed",
...
- ggvis
- shiny
- updated schedule - updated videos
- exploring your data (2 weeks)
...
* Webinar on open science: Josh to add link
