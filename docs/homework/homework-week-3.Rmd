...
If you've been paying close attention, you may have noticed that there was a flaw in our data cleaning procedure for the "content" column. We got rid of any values outside of 1-5, but there were some rows that had valid answers in them, but were filtered out by our filter, such as "4, Agree." We can see that should be a 4, but we need a way to catch these cases. 
