...
Put a way of finding out in the chunk below

```{r}

```

Get the last 10 rows and last 2 columns of `data` in the chunk below

```{r}

```

Get the `content` and `session_id` variables from `data` in the chunk below
