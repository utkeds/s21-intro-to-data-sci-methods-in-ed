...
last week's homework here: https://tennessee.zoom.us/rec/play/yJ1NDKe3Ln1b7odc0vI_MI8hNQcY9tX54JFZBx0_Y66VYU1gwe%5B%E2%80%A6%5Dv6qHyX4KBlPnqHssx9y.UsopmL1uFrV-A6R6?startTime=1611332611000
...
All of the videos can be found on the website as well: https://making-data-science-count.github.io/s21-intro-to-data-sci-methods-in-ed/videos.html
...
Add your code below to load the tidyverse suite of packages. Check out your 
...
We'll be using the gss_cat dataset for this homework. 
...
- Submit the .Rmd file you used to render a report to Canvas
- Upload the .html file you rendered to the #homework channel in Slack.
