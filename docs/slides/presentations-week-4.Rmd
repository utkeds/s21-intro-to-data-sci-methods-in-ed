...
- Provide as much detail as possible; it's much more helpful to us and others for you to try to explain what's going on, even if you're not certain about the terminology
- Consider searching (via Google) for the error message; it can be a bit an art to know what part of the message to Google
