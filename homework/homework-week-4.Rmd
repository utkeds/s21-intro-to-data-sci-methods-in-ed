...
The first thing you will need to do is get the data. You'll need the 2 ESM data
files: 
...
Separating the content variable by item is exactly what the `pivot_longer()` 
...
Can you visualize the person-item means that you just calculated? Try to do so using ggplot in the 
code chunk below:
...
Please post your comment(s), feedback, or reflections in Slack when you share your Rmd file!