...
1. Overview of course and discussion of syllabus
1. Check-out
...
library(here)
include_graphics("libs/img/jr-joro.jpg")
```
...
```{r, out.width = "400px", echo = FALSE, fig.align = "center", message = FALSE}
library(here)
include_graphics(here("libs", "img", ".jpg"))
```
...
**All materials here:**
https://making-data-science-count.github.io/s21-intro-to-data-sci-methods-in-ed/

**Ask questions on Slack:**
datascienceinedu.slack.com

# First activity: Data viz!
...
**Q: Why not python?**  
A: We can discuss that over coffee. (but short answer, it's doesn't have the data science functionality that R has, natively and through packages)
]
